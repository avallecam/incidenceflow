# Getting help with incidenceflow

Thanks for using incidenceflow. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/incidenceflow/issues) to make sure the 
